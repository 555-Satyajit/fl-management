    ...
    <div className="min-h-screen bg-[#FAF6F1]">
      ...
      <main className="pt-16 px-4 md:px-8 pb-8">
        ...
        <motion.div 
          ...
          className="max-w-6xl mx-auto mt-8 mb-12"
        >
          <div className="bg-[#2C1810] text-white rounded-2xl p-8 relative overflow-hidden">
            <div className="relative z-10">
              ...
              <motion.p 
                variants={itemVariants}
                className="text-[#E6B17E] text-lg"
              >
                Your farm's AI insights are ready
              </motion.p>
            </div>
            <svg className="absolute right-0 top-0 h-full w-1/2 text-[#8B4513]/10" viewBox="0 0 100 100">
              <path d="M50,0 Q75,25 50,50 T50,100" fill="none" stroke="currentColor" strokeWidth="2">
                <animate attributeName="d" dur="10s" repeatCount="indefinite"
                  values="M50,0 Q75,25 50,50 T50,100;
                          M50,0 Q25,25 50,50 T50,100;
